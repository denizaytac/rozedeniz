...
const translations = {
    de: {
        ...
        'faq.a1': 'Kommt so, wie ihr euch wohlfühlt! Wir freuen uns natürlich, wenn ihr euch ein bisschen schick macht, aber das Wichtigste ist, dass wir zusammen feiern. Ein Smoking oder Ballkleid ist nicht nötig.',
        'faq.q2': 'Darf ich jemanden mitbringen?',
        'faq.a2': 'Bitte habt Verständnis dafür, dass wir nur die auf der Einladung explizit genannten Personen einplanen können. Wenn auf deiner Einladung "+1" vermerkt ist, ist deine Begleitung herzlich willkommen.',
        'faq.q3': 'Gibt es Parkmöglichkeiten?',
        'faq.a3': 'Ja, es gibt Parkplätze direkt vor der Location. Diese sind für euch bereits reserviert und bezahlt.',
        'faq.q4': 'Dürfen wir Fotos machen?',
        'faq.a4': 'Ein professioneller Fotograf wird die wichtigsten Momente des Tages festhalten. Ihr dürft aber natürlich auch gerne selbst Fotos machen und diese in sozialen Netzwerken teilen! Nutzt dafür am besten unseren Hashtag #RozeDeniz2026. Wir würden uns riesig freuen, wenn ihr eure Schnappschüsse mit uns teilt! Wir werden vor Ort einen QR-Code (und später einen Link zu einer Dropbox) bereitstellen, über den ihr eure Bilder ganz einfach hochladen und mit uns sammeln könnt.',
    ...
    tr: {
        ...
        'faq.a1': 'Kendinizi rahat hissettiğiniz şekilde gelin! Biraz şık giyinirseniz tabii ki mutlu oluruz, ama en önemlisi birlikte kutlamak. Smokin veya balo elbisesi gerekli değil.',
        'faq.q2': 'Birini yanımda getirebilir miyim?',
        'faq.a2': 'Lütfen anlayışla karşılayın, sadece davette açıkça belirtilen kişileri planlayabiliyoruz. Davetinizde "+1" yazıyorsa, beraberinizdekilere de hoş geldiniz.',
        'faq.q3': 'Otopark imkanı var mı?',
        'faq.a3': 'Evet, mekanın önünde otopark bulunmaktadır. Bunlar sizin için zaten rezerve edilmiş ve ödenmiştir.',
        'faq.q4': 'Fotoğraf çekebilir miyiz?',
        'faq.a4': 'Profesyonel bir fotoğrafçı günün en önemli anlarını ölümsüzleştirecek. Ama siz de tabii ki kendi fotoğraflarınızı çekebilir ve sosyal medyada paylaşabilirsiniz! Bunun için #RozeDeniz2026 hashtagini kullanın. Çektiğiniz fotoğrafları bizimle paylaşırsanız çok mutlu oluruz! Orada bir QR kodu (ve daha sonra bir Dropbox linki) sağlayacağız, böylece fotoğraflarınızı kolayca yükleyip bizimle toplayabilirsiniz.',
    ...
    za: {
        ...
        'faq.a1': 'Xo rindkerdene ke şima xo rinde hîs kenê! Tabî ma şa bîme ke şima xo kêmê rinde bikerê, feqet cayê girîng ey o ke ma bi hev ra şadî bikerê. Smokîng yan zi libasê baloyî nêwazenîyê.',
        'faq.q2': 'Ez eşkena kesêk bi xo ra biarê?',
        'faq.a2': 'Keremê bike fehm bikerê ke ma tenya kesê ke ser dawetnameyî dîyar bîyayî eşkenê plan bikerîme. Eke dawetnameya şima de "+1" nuşîyayo, hewala şima zî bi xêrî ameyîş a.',
        'faq.q3': 'Cayê parkî esto?',
        'faq.a3': 'Heya, ver lokasyonî de cayê parkî estê. Nê cayê şima rê xora rezervkerdeyê û perekerdeyê.',
        'faq.q4': 'Ma eşkenîme fotoyan bigirîme?',
        'faq.a4': 'Fotografêko profesyonelî wextanê muhîmê rojê kodkerê. Feqet şima zî tabî eşkenê fotoyan bigirê û înan social mediayî de berzê bikerê! Hashtag ma #RozeDeniz2026 bikarînê. Eke fotoyanê xo bi ma ra parvaz bikerê, ma zaf şa bîme! Tîya de ma QR-kodêk (û badê linkêka Dropboxî) amade kerîme, ke şima fotoyanê xo bi asanî eşkenê bar bikerê û bi ma ra peyser bikerê.',
