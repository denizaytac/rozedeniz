...
const translations = {
    de: {
        ...
        'timeline.buffet': 'Buffet-Eröffnung',
        'timeline.openingdance': 'Eröffnungstanz',
        'timeline.cake': 'Hochzeitstorte',
        'timeline.end': 'Letzter Song',
        'timeline.guestbook': 'Im Saal liegt ein Gästebuch aus — wir freuen uns über jeden Eintrag.',
    ...
    tr: {
        ...
        'timeline.buffet': 'Büfe Açılışı',
        'timeline.openingdance': 'Açılış Dansı',
        'timeline.cake': 'Düğün Pastası',
        'timeline.end': 'Son Şarkı',
        'timeline.guestbook': 'Salonda bir anı defteri bulacaksınız — her yazı bizi çok mutlu eder.',
